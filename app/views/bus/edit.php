<div class="user-form-container">
    ...
    <form id="editBusForm" class="elegant-form" method="POST" action="index.php?action=updateBus">
        <input type="hidden" name="id" value="<?= $bus['id'] ?>">

        <div class="form-grid">
            <div class="form-group">
                <label for="immatriculation">Immatriculation</label>
                <input type="text" id="immatriculation" name="immatriculation" value="<?= htmlspecialchars($bus['immatriculation']) ?>" required>
            ...
            <div class="form-group">
                ...
                <select id="type" name="type" required>
                    <option value="" disabled hidden>Sélectionner un type</option>
            ...
            <div class="form-group">
                ...
                <input type="number" id="kilometrage" name="kilometrage" value="<?= htmlspecialchars($bus['kilometrage']) ?>" required>
                <div class="error-message">Champ requis</div>
            </div>

            <div class="form-group">
                <label for="nbre_places">Nombre de places</label>
                <input type="number" id="nbre_places" name="nbre_places" value="<?= htmlspecialchars($bus['nbre_places']) ?>" required>
                <div class="error-message">Champ requis</div>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="etat" name="etat" required>
                    <option value="" disabled hidden>Sélectionner un état</option>
            ...
            <div class="form-group">
                ...
                <input type="text" id="localisation" name="localisation" value="<?= htmlspecialchars($bus['localisation']) ?>" required>
                <div class="error-message">Champ requis</div>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="ligne_id" name="ligne_id" required>
                    ...
                    <?php foreach ($lignes as $ligne): ?>
                        <option value="<?= $ligne['id'] ?>" <?= $ligne['id'] == $bus['ligne_id'] ? 'selected' : '' ?>>
            ...
            <div class="form-group">
                ...
                <input type="text" id="zone" name="zone" value="<?= htmlspecialchars($bus['zone']) ?>">
            </div>
        </div>

        <div class="form-actions">
            <a href="index.php?action=buses" class="cancel-btn">
