<div class="user-form-container">
    ...
    <form id="editRoleForm" class="elegant-form" method="POST" action="index.php?action=updateRole">
        <input type="hidden" name="id" value="<?= $role['id'] ?>">

        <div class="form-grid">
            <div class="form-group full-width">
                <label for="libelle">Libellé</label>
                <input type="text" id="libelle" name="libelle" value="<?= htmlspecialchars($role['libelle']) ?>" required>
